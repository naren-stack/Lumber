...
export function GreenCtaFreeTrial({
  as: _Component = Section,
  alignCenterText = "Call our Lumber expert today!",
  ...
  heading2Text = "Ready to unlock productivity?",
}) {
  return (
    <_Component
      ...
      <Block className={_utils.cx(_styles, "container_lumber")} tag="div">
        ...
        >
          ...
          <Link
            ...
            options={freeButtonLink}
          >
            <Block tag="div">{ctaButtonLabel}</Block>
            <Block
